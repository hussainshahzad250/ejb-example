package com.example.messagedriven;
...
@WebServlet("/MessageDrivenExample")
public class MessageDrivenExample extends HttpServlet {

	private static final long serialVersionUID = 4548258332295734445L;

	public MessageDrivenExample() {
	}
